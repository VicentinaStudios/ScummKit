...
struct DirectoryView_v4: View {
    ...
    var body: some View {
        List {
            ...
            directory = Directory.createInOneLoop(from: $buffer.wrappedValue)
        }
    }
}

struct DirectoryView_v4_Previews: PreviewProvider {
